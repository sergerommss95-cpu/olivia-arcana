"""Portrait v6 — mirror the video v6 per-frame pipeline exactly.

The still portrait and the video frames should have identical grade so
they feel like the same shoot. The video uses subject_mask = skin +
turtleneck + hair_ish (hair region), portrait v4 used just skin +
turtleneck. This unifies them.
...
DEFAULT_SRC = _HERE / "public" / "olivia" / "portrait-original.jpg"
DEFAULT_OUT = _HERE / "public" / "olivia" / "portrait.jpg"
...
# Subject mask — identical to video v6.
...
bg_heavy = cv2.GaussianBlur(rgb, (0, 0), sigmaX=18.0)
...
warm = np.zeros_like(rgb); warm[..., 0] = 0.028; warm[..., 1] = 0.010; warm[..., 2] = -0.014
