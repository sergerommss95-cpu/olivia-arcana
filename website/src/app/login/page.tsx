...
export default function LoginPage() {
  ...
  if (!ACCOUNTS_ENABLED) {
    return (
      <ServicePaused
        title={isUk ? "Вхід призупинено" : "Sign-in is paused"}
        body={isUk ? "Ми перебудовуємо систему облікових записів. Читання тим часом не потребують входу." : "We're rebuilding the account system. Readings don't need an account in the meantime."}
      />
    );
  }
      ...
      <section className="auth">
        <div className="auth-sheet">
          ...
          <p className="auth-fine">
            Sign in or create account in one tap.
            <br />
