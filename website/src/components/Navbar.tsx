      ...
      <div className="max-w-screen-2xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          >
             ...
             <span className="relative z-10 text-[10px] font-bold tracking-[0.3em] uppercase text-celestial-gold group-hover:text-void-black transition-colors duration-500">
               Enter Oracle
             </span>
          </TransitionLink>
