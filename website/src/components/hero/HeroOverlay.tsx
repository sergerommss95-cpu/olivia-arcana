        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 pointer-events-auto">
          <div className="relative group">
            <input 
              ...
              className="w-72 px-8 py-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-full text-[#f5f0e8] placeholder:text-white/20 focus:outline-none focus:border-[#e0b768]/50 transition-all duration-500"
            />
          </div>
          <button className="px-10 py-4 bg-[#f5f0e8] text-black font-semibold rounded-full hover:bg-[#e0b768] transition-all duration-500 transform hover:scale-105">
            Begin Journey
          </button>
        </div>
      </div>
