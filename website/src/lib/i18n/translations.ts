...
const zh: Translations = {
  ...
  feat_eyebrow: "Olivia 的服务", feat_title: "你的星盘，为你解码",
  feat_1_title: "个人出生星盘", feat_1_desc: "基于 NASA JPL 星历表计算的本命星盘——你出生那一刻真实的行星位置，而非笼统的太阳星座模板。",
  feat_2_title: "每日宇宙指引", feat_2_desc: "每天清晨，一份专为你的星盘量身定制的解读，基于当日真实的行星过境。不是泛泛而谈——而是深度个人化。",
  feat_3_title: "塔罗牌解读", feat_3_desc: "从每日单张抽牌到深度 Celtic Cross 牌阵，每一份解读都与你的星象数据交织融合，带来层层洞见。",
  feat_4_title: "宇宙契合度", feat_4_desc: "两张出生星盘的完整合盘分析。金星与火星的互动、月亮的契合度，以及火花与摩擦的所在。",
  feat_5_title: "行星过境提醒", feat_5_desc: "当主要行星经过你星盘中的敏感点时，即时推送通知。土星进入你的第十宫？你会第一个知道。",
  feat_6_title: "个人视频解读", feat_6_desc: "一段 5 至 8 分钟的视频，Olivia 为你解读星盘与牌阵——专为你拍摄。最私密的解读体验。",
  how_eyebrow: "使用流程", how_title: "三步走向你的星辰",
  how_1_title: "提供出生信息", how_1_desc: "出生日期、时间和地点。Olivia 使用 NASA JPL 星历表计算你精确的行星位置。",
  how_2_title: "接收你的星盘", how_2_desc: "你完整的本命星盘——太阳、月亮、上升星座、所有行星、宫位与相位。你的宇宙蓝图。",
  how_3_title: "获取每日指引", how_3_desc: "每天清晨，Olivia 将当日真实行星过境叠加到你的星盘上。个性化、及时、基于真实行星位置。",
  dh_eyebrow: "每日星座运势", dh_title: "今日宇宙天气",
  dh_select: "在上方选择你的星座查看今日预览——或获取基于你精确出生星盘计算的完整个人解读。",
  dh_full_reading: "完整解读", dh_about: "关于",
  dh_reading_text: "今日的行星排列带来能量转变。当前的行星过境正在激活你星盘中的关键区域，创造成长与自我发现的机遇。要获取基于你精确出生星盘——而非仅凭太阳星座——的完整个人化解读，请与 Olivia 开始对话。",
  dh_sign_tag: "星座",
  test_eyebrow: "来自社区", test_title: "星辰之声",
  test_1_quote: "市面上的星座应用我都试过了。Olivia 是唯一真正引用我实际星盘的——而不是只看太阳星座。那些解读就像是专门为我写的。",
  test_1_name: "Sarah M.", test_1_sign: "♏ 天蝎座日, ♓ 双鱼座月",
  test_2_quote: "契合度解读精准得令人惊叹。它精确指出了我们关系中多年来一直在处理的紧张点。现在我终于明白了背后的宇宙缘由。",
  test_2_name: "Marcus T.", test_2_sign: "♌ 狮子座日, ♎ 天秤座升",
  test_3_quote: "我的晨间仪式：咖啡，然后是 Olivia 的每日解读。它已成为我的冥想。行星过境提醒在水星逆行期间救了我——我终于提前做好了准备。",
  test_3_name: "Elena K.", test_3_sign: "♒ 水瓶座日, ♋ 巨蟹座月",
  price_eyebrow: "价格方案", price_title: "解锁你的完整星盘",
  price_free: "免费", price_free_desc: "开启宇宙探索之旅", price_forever: "永久免费",
  price_free_f1: "每日 5 条消息与 Olivia 对话", price_free_f2: "每日十二星座运势",
  price_free_f3: "每日塔罗牌", price_free_f4: "三张塔罗牌阵（每日一次）",
  price_free_f5: "基础契合度摘要", price_free_f6: "每周宇宙天气",
  price_start_free: "免费开始",
  price_vip: "VIP", price_vip_desc: "完整宇宙体验", price_popular: "最受欢迎",
  price_month: "/月", price_annual: "或 $65/年（免费两个月）",
  price_vip_f1: "与 Olivia 无限畅聊", price_vip_f2: "每日个人解读（你的星盘 + 当日过境）",
  price_vip_f3: "本命星盘敏感点实时过境提醒", price_vip_f4: "每周个性化塔罗抽牌",
  price_vip_f5: "每月 Celtic Cross 解读已包含", price_vip_f6: "完整契合度/合盘报告",
  price_vip_f7: "日食月食与逆行影响报告", price_vip_f8: "生日太阳回归解读",
  price_vip_f9: "优先响应——永不排队", price_start_vip: "开通 VIP",
  price_pay: "通过 Telegram Stars 或加密货币 (TON/USDT) 支付",
  price_individual: "或单独体验高级解读：",
  price_i1: "出生星盘", price_i2: "契合度", price_i3: "Celtic Cross", price_i4: "年度预测", price_i5: "视频解读",
  cta_title: "你的星辰在等你",
  cta_subtitle: "从你出生的那一刻起，宇宙便在书写你的故事。是时候去阅读它了。",
  cta_button: "获取免费解读", cta_note: "免费出生星盘解读。无需付费。仅需 2 分钟。",
  foot_desc: "使用 NASA JPL 星历表数据，基于你精确的行星位置计算的个性化星象解读。你的星盘。你的真相。",
  foot_explore: "探索", foot_connect: "关注",
  foot_copyright: "星辰指引，由你决定。", foot_data: "天文数据：NASA JPL DE440/DE441 Ephemeris",
  foot_tg_bot: "Telegram 机器人", foot_tg_channel: "Telegram 频道",
  compat_title: "宇宙契合度", compat_subtitle: "输入两个生日，揭示你们的星际连结",
  compat_person1: "第一人", compat_person2: "第二人", compat_overall: "综合契合度",
  compat_love: "爱情", compat_comm: "沟通", compat_trust: "信任", compat_passion: "激情",
  compat_v1: "写在星辰中的宇宙良缘。这份连结超越凡俗。",
