...
const en: Translations = {
  ...
  hero_trust_line: "Clarity first. No noise.",
  ...
  oracle_focus_title: "Ask one clear question.",
  oracle_focus_subtitle: "Choose three cards, then reveal the reading.",
  oracle_focus_cta: "Choose cards",
  oracle_preparing_pattern: "Finding the pattern…",
  oracle_spread_forming: "Three cards are chosen.",
  oracle_spread_cta: "Reveal the reading",
  oracle_result_title: "The reading is clear.",
  oracle_result_cta: "See the full reading plans",
  oracle_result_subtitle: "Add timing, chart context, and symbolic connections.",
  oracle_result_disclaimer: "For reflection, not a promise of outcomes.",
  ...
  portrait_generate: "Draw your portrait", portrait_download: "Download Portrait",
  ...
  chart_title: "Your Birth Chart", chart_compute: "Draw your chart",
  ...
  feat_1_title: "Personal Birth Chart", feat_1_desc: "Your natal chart calculated from high-precision astronomical ephemeris \u2014 the exact planetary positions at the moment of your birth. Not a sun-sign template.",
  ...
  how_1_title: "Share Your Birth Data", how_1_desc: "Date, time, and place of birth. Olivia calculates your exact planetary positions using a high-precision astronomical ephemeris.",
  ...
  price_free: "Free Reading", price_free_desc: "Try the daily ritual", price_forever: "forever",
  price_insight: "Personal", price_insight_desc: "For regular reflection",
  price_premium: "Premium", price_premium_desc: "For full chart context",
  price_vip: "Private", price_vip_desc: "For bespoke support", price_popular: "Most Popular",
  price_month: "/month", price_annual: "or $65/year (2 months free)",
  price_f_free: [
    "Daily tarot card",
    "Basic birth chart context",
    "3 Oracle questions per month",
    "Current planetary timing"
  ],
  price_f_insight: [
  ...
  price_f_vip: [
    ...
    "Priority support",
    "Early access to new readings"
  ],
  price_start_free: "Start free", price_start_insight: "Choose Personal", price_start_premium: "Choose Premium", price_start_vip: "Choose Private",
  ...
  // Footer
  foot_desc: "Personal astrology and tarot readings for reflection. Your chart gives the context; your choices stay yours.",
  foot_explore: "Explore", foot_connect: "Connect",
  foot_copyright: "The stars guide, you decide.",
  foot_data: "For entertainment and self-reflection, not professional advice.",
...
const uk: Translations = {
  ...
  hero_trust_line: "Спершу ясність. Без шуму.",
  ...
  oracle_focus_title: "Сформулюйте одне чітке запитання.",
  oracle_focus_subtitle: "Оберіть три карти, потім відкрийте читання.",
  oracle_focus_cta: "Обрати карти",
  oracle_preparing_pattern: "Шукаємо зв’язок…",
  oracle_spread_forming: "Три карти обрано.",
  oracle_spread_cta: "Відкрити читання",
  oracle_result_title: "Читання завершено.",
  oracle_result_cta: "Переглянути повні плани читань",
  oracle_result_subtitle: "Додайте час, контекст карти й символічні зв’язки.",
  oracle_result_disclaimer: "Для саморефлексії, не як обіцянка результату.",
  ...
  feat_1_title: "Персональна натальна карта", feat_1_desc: "Ваша натальна карта розрахована на основі ефемерид JPL — реальні позиції планет у точний момент вашого народження. Не шаблон за знаком Сонця.",
  ...
  how_1_title: "Поділіться даними народження", how_1_desc: "Дата, час і місце народження. Olivia розраховує точні позиції ваших планет за допомогою ефемерид JPL.",
  ...
  price_free: "Безкоштовно", price_free_desc: "Спробувати щоденний ритуал", price_forever: "назавжди",
  price_insight: "Особистий", price_insight_desc: "Для регулярної рефлексії",
  price_premium: "Преміум", price_premium_desc: "Для повного контексту карти",
  price_vip: "Приватний", price_vip_desc: "Для індивідуальної підтримки", price_popular: "Найпопулярніший",
  price_month: "/місяць", price_annual: "або $65/рік (2 місяці безкоштовно)",
  price_f_free: [
    "Щоденна карта Таро",
    "Базовий контекст карти",
    "3 запитання до Оракула на місяць",
    "Поточний планетарний момент"
  ],
  price_f_insight: [
    "Особисті щоденні читання",
    "Читання натальної карти",
  ...
  price_f_vip: [
    ...
    "Ранній доступ до нових читань"
  ],
  price_start_free: "Почати безкоштовно", price_start_insight: "Обрати Особистий", price_start_premium: "Обрати Преміум", price_start_vip: "Обрати Приватний",
  ...
  foot_desc: "Персональні астрологічні й таро-читання для рефлексії. Ваша карта дає контекст; рішення залишаються за вами.",
  foot_explore: "Дослідити", foot_connect: "Зв’язатися",
  foot_copyright: "Зірки вказують, ви вирішуєте.", foot_data: "Для розваги й саморефлексії, не професійна порада.",
...
const ru: Translations = {
  ...
  hero_almanac_badge: "✦ Личный оракул",
  hero_title: "Ваши звёзды — ясным языком.",
  hero_subtitle: "Персональные астрологические и таро-чтения с учётом вашей натальной карты, текущих транзитов и вопроса, с которым вы приходите.",
  hero_trust_line: "Личные, рефлексивные чтения. Создано для ясности, а не шума.",
  hero_consult_cta: "Спросить Оракула",
  hero_sample_cta: "Посмотреть чтение на сегодня",
  ...
  feat_1_title: "Персональная натальная карта", feat_1_desc: "Ваша натальная карта рассчитана на основе эфемерид JPL — реальные позиции планет в точный момент вашего рождения. Не шаблон по знаку Солнца.",
  ...
  how_1_title: "Поделитесь данными рождения", how_1_desc: "Дата, время и место рождения. Olivia рассчитывает точные позиции ваших планет с помощью эфемерид JPL.",
  ...
  foot_desc: "Персонализированные астрологические чтения, рассчитанные по вашим точным позициям планет с использованием данных эфемерид JPL. Ваша карта. Ваша правда.",
  foot_explore: "Исследовать", foot_connect: "Связаться",
  foot_copyright: "Звёзды направляют, вы решаете.", foot_data: "Астрономические данные: JPL DE440/DE441 Ephemeris. Not affiliated with NASA.",
  foot_tg_bot: "Telegram-бот", foot_tg_channel: "Telegram-канал",
...
const de: Translations = {
  ...
  hero_almanac_badge: "✦ Persönliches Orakel",
  hero_title: "Deine Sterne, klar übersetzt.",
  hero_subtitle: "Persönliche Astrologie- und Tarot-Lesungen, geprägt von deinem Geburtshoroskop, aktuellen Transiten und deiner Frage.",
  hero_trust_line: "Persönliche, reflektierende Readings. Für Klarheit gemacht, nicht für Lärm.",
  hero_consult_cta: "Das Orakel fragen",
  hero_sample_cta: "Heutiges Reading ansehen",
  ...
  feat_1_title: "Persönliches Geburtshoroskop", feat_1_desc: "Dein Geburtshoroskop, berechnet mit der JPL Ephemeride — echte Planetenpositionen im exakten Moment deiner Geburt. Keine Sternzeichen-Schablone.",
  ...
  how_1_title: "Teile deine Geburtsdaten", how_1_desc: "Datum, Uhrzeit und Geburtsort. Olivia berechnet deine exakten Planetenpositionen mit der JPL Ephemeride.",
  ...
  foot_desc: "Personalisierte Astrologie-Readings, berechnet aus deinen exakten Planetenpositionen mit JPL Ephemeriden-Daten. Dein Horoskop. Deine Wahrheit.",
  foot_explore: "Entdecken", foot_connect: "Verbinden",
  foot_copyright: "Die Sterne weisen den Weg, du entscheidest.", foot_data: "Astronomische Daten: JPL DE440/DE441 Ephemeride. Not affiliated with NASA.",
...
const fr: Translations = {
  ...
  hero_almanac_badge: "✦ Oracle personnel",
  hero_title: "Vos étoiles, traduites clairement.",
  hero_subtitle: "Lectures personnelles d’astrologie et de tarot façonnées par votre thème natal, les transits actuels et la question que vous apportez.",
  hero_trust_line: "Des lectures personnelles et réflexives. Pensées pour la clarté, pas le bruit.",
  hero_consult_cta: "Demander à l’Oracle",
  hero_sample_cta: "Voir la lecture du jour",
  ...
  feat_1_title: "Thème natal personnel", feat_1_desc: "Votre thème natal calculé à partir des éphémérides JPL — les positions planétaires réelles au moment exact de votre naissance. Pas un modèle basé sur le signe solaire.",
  ...
  how_1_title: "Partagez vos données de naissance", how_1_desc: "Date, heure et lieu de naissance. Olivia calcule vos positions planétaires exactes grâce aux éphémérides JPL.",
  ...
  foot_desc: "Lectures d’astrologie personnalisées calculées à partir de vos positions planétaires exactes grâce aux données des éphémérides JPL. Votre thème. Votre vérité.",
  foot_explore: "Explorer", foot_connect: "Se connecter",
  foot_copyright: "Les étoiles guident, vous décidez.", foot_data: "Données astronomiques : JPL DE440/DE441 Éphémérides. Not affiliated with NASA.",
...
const ar: Translations = {
  ...
  hero_almanac_badge: "✦ أوراكل شخصي",
  hero_title: "نجومك مترجمة بوضوح.",
  hero_subtitle: "قراءات فلك وتاروت شخصية تتشكل من خريطة ميلادك، والعبور الحالي، والسؤال الذي تحضره.",
  hero_trust_line: "قراءات شخصية وتأملية. صُممت للوضوح لا للضجيج.",
  hero_consult_cta: "اسأل الأوراكل",
  hero_sample_cta: "شاهد قراءة اليوم",
  ...
  witness_node_relic: "الخريطة",
  witness_status_idle: "تركيز",
  witness_status_listening: "جاري الاستماع...",
  witness_status_computing: "جاري القراءة...",
  ...
  feat_1_title: "خريطة الميلاد الشخصية", feat_1_desc: "خريطتك الفلكية محسوبة من بيانات JPL الفلكية — مواقع الكواكب الحقيقية في اللحظة الدقيقة لميلادك. ليست قالبًا عامًا للأبراج.",
  ...
  how_1_title: "شارك بيانات ميلادك", how_1_desc: "التاريخ، الوقت، ومكان الولادة. تحسب Olivia مواقعك الكوكبية الدقيقة باستخدام بيانات JPL الفلكية.",
  ...
  foot_desc: "قراءات فلكية مخصصة محسوبة من مواقعك الكوكبية الدقيقة باستخدام بيانات JPL الفلكية. خريطتك. حقيقتك.",
  foot_explore: "استكشف", foot_connect: "تواصل",
  foot_copyright: "النجوم ترشد، وأنت تقرر.", foot_data: "البيانات الفلكية: JPL DE440/DE441 Ephemeris. Not affiliated with NASA.",
...
const es: Translations = {
  ...
  hero_almanac_badge: "✦ Oráculo personal",
  hero_title: "Tus estrellas, traducidas con claridad.",
  hero_subtitle: "Lecturas personales de astrología y tarot guiadas por tu carta natal, los tránsitos actuales y la pregunta que traes.",
  hero_trust_line: "Lecturas personales y reflexivas. Hechas para la claridad, no para el ruido.",
  hero_consult_cta: "Preguntar al Oráculo",
  hero_sample_cta: "Ver la lectura de hoy",
  ...
  feat_1_title: "Carta natal personal", feat_1_desc: "Tu carta natal calculada con efemérides JPL — posiciones planetarias reales en el momento exacto de tu nacimiento. No es una plantilla genérica.",
  ...
  how_1_title: "Comparte tus datos de nacimiento", how_1_desc: "Fecha, hora y lugar de nacimiento. Olivia calcula tus posiciones planetarias exactas usando las efemérides JPL.",
  ...
  foot_desc: "Lecturas astrológicas personalizadas calculadas a partir de tus posiciones planetarias exactas usando datos de efemérides JPL. Tu carta. Tu verdad.",
  foot_explore: "Explorar", foot_connect: "Conectar",
  foot_copyright: "Las estrellas guían, tú decides.", foot_data: "Datos astronómicos: JPL DE440/DE441 Ephemeris. Not affiliated with NASA.",
...
const pt: Translations = {
  ...
  hero_almanac_badge: "✦ Oráculo pessoal",
  hero_title: "Suas estrelas, traduzidas com clareza.",
  hero_subtitle: "Leituras pessoais de astrologia e tarô moldadas pelo seu mapa natal, pelos trânsitos atuais e pela pergunta que você traz.",
  hero_trust_line: "Leituras pessoais e reflexivas. Feitas para clareza, não ruído.",
  hero_consult_cta: "Perguntar ao Oráculo",
  hero_sample_cta: "Ver a leitura de hoje",
  ...
  feat_1_title: "Mapa natal pessoal", feat_1_desc: "Seu mapa natal calculado a partir das efemérides JPL — posições planetárias reais no momento exato do seu nascimento. Não é um modelo genérico de signo solar.",
  ...
  how_1_title: "Compartilhe seus dados de nascimento", how_1_desc: "Data, hora e local de nascimento. Olivia calcula suas posições planetárias exatas usando as efemérides JPL.",
  ...
  foot_desc: "Leituras astrológicas personalizadas calculadas a partir das suas posições planetárias exatas usando dados de efemérides JPL. Seu mapa. Sua verdade.",
  foot_explore: "Explorar", foot_connect: "Conectar",
  foot_copyright: "As estrelas guiam, você decide.", foot_data: "Dados astronômicos: JPL DE440/DE441 Ephemeris. Not affiliated with NASA.",
