...
const zh: Translations = {
  ...
  academy_back: "学院",
  academy_home_link: "首页",
  academy_card_of_day_desc: "每日塔罗牌抽取与解读",
  academy_tarot_encyclopedia_desc: "全部78张牌详解",
  academy_aspect_guide_desc: "行星之间如何交流",
  academy_live_cosmos: "实时星空",
  academy_live_cosmos_desc: "行星实时位置",
  academy_track_astrology: "占星术",
  academy_track_astrology_desc: "从星座基础到高级星盘解读",
  academy_track_tarot: "塔罗牌",
  academy_track_tarot_desc: "牌义、牌阵与直觉式解读技巧",
  academy_track_integrated: "综合实践",
  academy_track_integrated_desc: "融合占星与塔罗，获得多层次的宇宙洞见",
  academy_filter_all: "全部 (78)",
  academy_filter_major: "大牌 (22)",
  academy_filter_wands: "权杖",
  academy_filter_cups: "圣杯",
  academy_filter_swords: "宝剑",
  academy_filter_pentacles: "星币",
  academy_search_placeholder: "按名称或关键词搜索...",
  academy_upright: "正位",
  academy_reversed: "逆位",
  academy_advice: "建议",
  academy_astrology_label: "占星",
  academy_element_label: "元素",
  academy_yesno_label: "是 / 否",
  academy_select_card_hint: "点击任意牌查看完整含义",
  academy_major_arcana: "大阿尔卡纳",
  academy_minor_arcana: "小阿尔卡纳",
  academy_draw_again: "再次抽牌",
  academy_preparing_veil: "正在准备面纱...",
  academy_lift_veil_touch: "触摸并按住以揭开面纱",
  academy_lift_veil_press: "按住以揭开面纱",
  academy_what_youll_learn: "你将学到什么",
  academy_content_label: "内容",
  academy_duration_label: "时长",
  academy_course_cta: "准备好开始你的宇宙之旅了吗？",
  academy_level_beginner: "初学者",
  academy_level_intermediate: "中级",
  academy_level_advanced: "高级",
  academy_lesson_type: "课程",
  academy_interactive_type: "互动",
  academy_quiz_type: "测验",
  academy_practice_type: "练习",
  academy_key_takeaway: "核心要点",
  academy_check_answers: "检查答案",
  academy_quiz_perfect: "满分！你已掌握这部分内容。",
  academy_quiz_great: "做得很好！查看你遗漏题目的解析。",
  academy_quiz_keep_studying: "继续学习——回顾课程内容，再试一次。",
  academy_journal_prompt: "日记主题",
  academy_exercise_complete: "练习完成",
  academy_min_abbr: "分钟",
  academy_widget_loading: "正在加载互动组件...",
  academy_callout_insight: "洞见",
  academy_callout_note: "注意",
  academy_callout_tip: "提示",
