  ...
  "celtic-cross": {
    sections: [
      ...
      },
      {
        ...
        body: "Position 1 (Center): The present situation — what you are dealing with right now.\nPosition 2 (Crossing): The challenge or obstacle crossing you. This is what complicates the situation.\nPosition 3 (Crown): What crowns you — the conscious aim, ideal, or best that can be achieved in the situation.\nPosition 4 (Root): What lies beneath — the unconscious foundation or root cause of the situation.\nPosition 5 (What Is Passing): What is behind you — an influence that has just passed or is fading away.\nPosition 6 (What Approaches): What is before you — the influence approaching in the immediate future.\nPosition 7 (Self): Your attitude, feelings, and approach to the situation.\nPosition 8 (Environment): External influences — other people, circumstances, energy around you.\nPosition 9 (Hopes & Fears): What you hope for and what you fear (often the same thing).\nPosition 10 (Outcome): The likely outcome given the current trajectory.",
      },
      {
        type: "text",
        title: "Reading the Celtic Cross as a Story",
        body: "The power of the Celtic Cross is narrative. Positions 3-4 form a vertical axis of consciousness — the crown above shows what you consciously aim for, while the root beneath reveals the unconscious foundation. Positions 5-6 create a timeline: what is passing behind you and what approaches before you. Positions 7-8 reveal the interplay between inner and outer worlds. Position 9 often holds the psychological key — the fear that is creating the obstacle.\n\nBegin by reading the center cross (1-2) as the core drama. Then read the vertical axis (3-4) for the conscious-unconscious tension, and the horizontal timeline (5-6) for movement through time. Finally, read the staff (7-10) as the deeper psychological and environmental context. The outcome card (10) is not fixed — it reflects the most likely trajectory given everything else in the spread.",
      },
